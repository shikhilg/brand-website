      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full py-32">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-16">
          <div className="max-w-3xl flex-1">
            {/* Profile photo — mobile (above heading) */}
            <div className="animate-fade-in lg:hidden mb-8">
              <a href={SITE_CONFIG.linkedin} target="_blank" rel="noopener noreferrer" className="relative inline-block group">
                <div className="absolute -inset-2 rounded-full bg-accent/10 blur-xl group-hover:bg-accent/20 transition-colors duration-300" />
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden ring-2 ring-foreground/10 ring-offset-2 ring-offset-background group-hover:ring-accent/40 transition-all duration-300">
                  <Image
                    src="/profile.png"
                    alt="Shikhil Kumar Gupta"
                    fill
          ...
          {/* Profile photo */}
          <div className="animate-fade-in hidden lg:block shrink-0" style={{ animationDelay: "0.4s" }}>
            <a href={SITE_CONFIG.linkedin} target="_blank" rel="noopener noreferrer" className="relative block group cursor-pointer">
              <div className="absolute -inset-3 rounded-full bg-accent/10 blur-2xl group-hover:bg-accent/20 transition-colors duration-300" />
              <div className="relative w-64 h-64 xl:w-72 xl:h-72 rounded-full overflow-hidden ring-2 ring-foreground/10 ring-offset-4 ring-offset-background group-hover:ring-accent/40 transition-all duration-300">
                <Image
                  src="/profile.png"
                  alt="Shikhil Kumar Gupta"
                  fill
